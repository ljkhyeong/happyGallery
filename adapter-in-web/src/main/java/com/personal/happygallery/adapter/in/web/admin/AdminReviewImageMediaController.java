...
public class AdminReviewImageMediaController {

    private final ReviewImageMediaUseCase reviewImageMediaUseCase;

    public AdminReviewImageMediaController(ReviewImageMediaUseCase reviewImageMediaUseCase) {
        this.reviewImageMediaUseCase = reviewImageMediaUseCase;
    }

    @GetMapping("/{reviewId}/images/{imageId}")
    @Operation(
            operationId = "getAdminReviewImage",
    ...
    public ResponseEntity<byte[]> getImage(
        ...
        ImageContent image =
                reviewImageMediaUseCase.getAdminImage(reviewId, imageId);
