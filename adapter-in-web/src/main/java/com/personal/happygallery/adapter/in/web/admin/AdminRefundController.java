...
import com.personal.happygallery.adapter.in.web.admin.dto.FailedRefundPageResponse;
...
public class AdminRefundController {
    ...
    @GetMapping("/failed")
    public FailedRefundPageResponse listFailed(
            @RequestParam(required = false) String cursor,
            @RequestParam(defaultValue = "20") int size) {
        return FailedRefundPageResponse.from(refundRetryUseCase.listFailed(cursor, size));
    }
