...
public record OfficialReviewReplyResponse(
    ...
    public static OfficialReviewReplyResponse from(OfficialReplyItem reply) {
        if (reply == null) {
            return null;
        }
        return new OfficialReviewReplyResponse(
                reply.content(), reply.createdAt(), reply.editedAt(), reply.editedAt() != null);
    }
}
