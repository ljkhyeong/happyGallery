...
public class KeyRotationRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        log.info("키 회전 완료 [users={}, guests={}, attempts={}, fulfillments={}, social={}, "
                        + "deletedVerifications={}, pendingSocial={}]",
                result.users(), result.guests(), result.paymentAttempts(), result.fulfillments(),
                result.socialAccounts(), result.deletedPhoneVerifications(), result.pendingSocialAccounts());
