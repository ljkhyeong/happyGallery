 ...
 * {@link BookingCancellationService}를 구현한다.
 */
@Service
@Transactional
class DefaultBookingCancellationService implements BookingCancellationService {
    ...
    private void cancelOne(Booking booking, Long passId) {
        ...
        bookingSupport.recordHistory(booking, BookingHistoryAction.CANCELED,
                slot, null, "SYSTEM", null, "이용권 전체 환불 연동 취소");
