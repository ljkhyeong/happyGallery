...
public interface AdminSessionPort {
    ...
    /** 새 세션을 생성하고 토큰을 반환한다. */
    String create(Long adminUserId, String username, long credentialVersion, boolean mfaEnabled);
    ...
    /** 한 관리자에게 이전 자격 증명 버전으로 발급된 세션을 모두 제거한다. */
    void removeAll(Long adminUserId, long credentialVersion);
}
