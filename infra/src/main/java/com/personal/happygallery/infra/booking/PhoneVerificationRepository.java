...
public interface PhoneVerificationRepository extends JpaRepository<PhoneVerification, Long>,
        PhoneVerificationReaderPort, PhoneVerificationStorePort {

    @Override PhoneVerification save(PhoneVerification phoneVerification);
    ...
    @Override
    default Optional<PhoneVerification> findValidVerification(String phone, String code, LocalDateTime now) {
        return findByPhoneAndCodeAndVerifiedFalseAndExpiresAtAfter(phone, code, now);
    }

    @Override
    default Optional<PhoneVerification> findLatestUnverifiedCode(String phone) {
        return findTopByPhoneAndVerifiedFalseOrderByIdDesc(phone);
    }
}
