...
validate_allowed_env_keys "$app_file" 애플리케이션 \
    ...
    ROAD_ADDRESS_ENABLED ROAD_ADDRESS_CONFIRMATION_KEY \
    ROAD_ADDRESS_BASE_URL \
    ROAD_ADDRESS_TIMEOUT_MILLIS ROAD_ADDRESS_CONNECT_TIMEOUT_MILLIS \
    ROAD_ADDRESS_ACQUIRE_TIMEOUT_MILLIS ROAD_ADDRESS_MAX_CONNECTIONS \
    ROAD_ADDRESS_KEEP_ALIVE_MILLIS \
