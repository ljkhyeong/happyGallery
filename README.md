...
- 현재 React 실사용 전환 범위는 공개 상품·Q&A, 회원 소셜 계정·알림, 고객 결제 상태·복구, 공방 정보, 정책 동의, 관리자 인증·MFA·대시보드·예약·주문 클레임·상품 Q&A다. 새 엔드포인트는 필수값·nullable·enum 정확성을 확인한 뒤 같은 방식으로 전환한다.
