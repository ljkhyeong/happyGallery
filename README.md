...
`happyGallery`는 오프라인 공방의 상품 주문, 클래스 예약, 8회권과 회원·관리자 기능을 제공한다.
...
| 회원 | 주문·예약·8회권 관리, 장바구니, 쿠폰·적립금, 후기·문의, 찜·알림·기본 배송지, 로그인 수단·연락처 관리와 탈퇴 |
...
- [제품 명세](docs/PRD/0001_기준_스펙/spec.md): 주문·옵션·재고, 예약·8회권, 쿠폰·적립금, 후기·문의, 공방 프로필·공휴일·알림 규칙
