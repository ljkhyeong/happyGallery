...
function contentSecurityPolicy(nonce: string): string {
  return [
    ...
    "form-action 'self'",
    `script-src 'self' 'report-sample' 'nonce-${nonce}' https://js.tosspayments.com https://t1.kakaocdn.net https://challenges.cloudflare.com`,
    ...
    "frame-src https://tosspayments.com https://*.tosspayments.com https://postcode.map.kakao.com https://challenges.cloudflare.com",
    "manifest-src 'self'",
    "media-src 'self'",
