...
const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  REVIEW_ALREADY_EXISTS: "이 주문 상품이나 예약에는 이미 후기를 작성했습니다. 기존 후기를 수정해 주세요.",
  REVIEW_RECREATION_BLOCKED: "공방에서 비공개 처리한 후기는 같은 주문 상품이나 예약에 다시 작성할 수 없습니다.",
  ...
  REVIEW_INTERACTION_NOT_ALLOWED: "공개 중인 후기만 도움돼요를 누르거나 신고할 수 있습니다.",
  ...
  REFUND_NOT_ALLOWED: "환불할 수 없습니다. 환불 조건과 처리 상태를 확인해 주세요.",
  PRODUCTION_REFUND_NOT_ALLOWED: "제작 중에는 환불할 수 없습니다.",
  CHANGE_NOT_ALLOWED: "현재는 변경할 수 없습니다. 변경 가능한 조건을 확인해 주세요.",
  PASS_EXPIRED: "이용권이 만료되었습니다.",
  PASS_CREDIT_INSUFFICIENT: "이용권의 남은 횟수가 부족합니다.",
  ...
  PAYMENT_RESULT_RETENTION_EXPIRED: "결제 결과 조회 기간이 지났습니다. 주문·예약 또는 이용권 내역을 확인해 주세요.",
  ...
  REAUTHENTICATION_REQUIRED: "계정 정보를 변경하려면 본인 확인을 다시 해 주세요.",
