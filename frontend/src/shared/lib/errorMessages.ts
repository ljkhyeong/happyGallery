...
const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  REVIEW_RECREATION_BLOCKED: "운영 정책으로 숨김 처리된 이력이 있어 같은 이용 건에 후기를 다시 작성할 수 없습니다.",
  REVIEW_REPORT_ALREADY_EXISTS: "이미 신고한 후기입니다. 운영자의 확인을 기다려 주세요.",
  REVIEW_NOT_ALLOWED: "완료된 주문 상품이나 클래스에만 후기를 작성할 수 있습니다.",
