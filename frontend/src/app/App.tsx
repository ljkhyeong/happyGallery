...
const MyBenefitsPage = lazy(() =>
  import("@/pages/MyBenefitsPage").then((module) => ({ default: module.MyBenefitsPage })),
);
              ...
              <BrowserRouter>
                ...
                <Routes>
                  <Route element={<Layout />}>
                    ...
                    <Route path="/events/:id" element={<LazyRoute><EventDetailPage /></LazyRoute>} />
